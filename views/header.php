                ...
                <?php
                    ...
                    } else 
                    {
                        echo '<li class="nav-item"><a href="index.php" class="nav-link text-white">HOME</a></li>
                            <li class="nav-item"><a href="/views/admin/adminlogin.php" class="nav-link text-white">ADMIN</a></li>
                            <li class="nav-item"><a href="/views/doctor/doctorlogin.php" class="nav-link text-white">DOCTOR</a></li>
                            <li class="nav-item"><a href="/views/patient/patientlogin.php" class="nav-link text-white">PATIENT</a></li>';
                    }
                ?>
            </ul>
        </div>
